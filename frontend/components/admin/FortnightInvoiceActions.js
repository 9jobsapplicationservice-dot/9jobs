  ...
  return (
    <div className="admin-actions-row">
      <button
        ...
        onClick={() => runAction('generate', `/api/fortnight-invoices/${invoiceId}/generate-pdf`)}
        type="button"
      >
        {pendingAction === 'generate' ? 'Generating...' : hasGeneratedPdf ? 'Regenerate Preview' : 'Generate Preview'}
      </button>
      <Link className="admin-dark-button admin-dark-button--link" href={`/admin/fortnight-invoices/${invoiceId}/edit`} prefetch={false}>
        Edit
      </Link>
      <button
        className="admin-dark-button"
        disabled={pendingAction === 'paymentLink'}
        onClick={() => runAction('paymentLink', `/api/fortnight-invoices/${invoiceId}/payment-link`)}
        type="button"
      >
      ...
      <button
        ...
        onClick={() => runAction('emailLink', `/api/fortnight-invoices/${invoiceId}/send-payment-link`)}
        type="button"
      >
      ...
      <button
        ...
        onClick={() => runAction('send', `/api/fortnight-invoices/send/${invoiceId}`)}
        type="button"
      >
      ...
      <button
        ...
        onClick={() =>
          runAction('whatsapp', `/api/fortnight-invoices/${invoiceId}/payment-link`, {
            onSuccess: (data) => {
